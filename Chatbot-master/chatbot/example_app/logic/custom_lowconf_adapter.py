...
class CustomLowConfidenceAdapter(BestMatch):
    """
    ...
    def __init__(self, **kwargs):
        super(CustomLowConfidenceAdapter, self).__init__(**kwargs)

        self.confidence_threshold = kwargs.get('threshold', 0.65)

        default_response = kwargs.get(
            'default_response', "I'm sorry, I am not able to understand your inquiry. Please try rewording your sentence and including more SPC keywords. Thanks!"
        )
